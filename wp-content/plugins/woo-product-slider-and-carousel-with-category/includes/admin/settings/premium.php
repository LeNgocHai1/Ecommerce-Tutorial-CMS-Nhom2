...
<div class="wrap">
	...
	<h2><span class="wcpscwc-sf-blue">Product Slider and Carousel with Category for WooCommerce </span>Including in <span class="wcpscwc-sf-blue">Essential Plugin Bundle</span></h2>
		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					<h1 style="font-size: 28px; font-weight: 700; letter-spacing: -1px; text-align: center; margin-top: 30px; margin-bottom: 5px;">Only <span class="wcpscwc-sf-blue">November 2022</span> Deal <span class="wcpscwc-sf-blue">40% OFF</span></h1>
					...
					<h3><span style="text-decoration:line-through; color: #FF1000;">$299</span> <span class="wcpscwc-sf-blue" style="font-size:30px;">$179</span> Unlimited Site License</h3>
					<a href="<?php echo WCPSCWC_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
				...
				<div style="text-align: center;">
					...
					<a href="<?php echo WCPSCWC_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
				</div>

			<?php /*	<h3 style="text-align:center"><?php _e( 'Compare "Product Slider and Carousel with Category for WooCommerce" Free VS Pro', 'woo-product-slider-and-carousel-with-category' ); ?></h3>
