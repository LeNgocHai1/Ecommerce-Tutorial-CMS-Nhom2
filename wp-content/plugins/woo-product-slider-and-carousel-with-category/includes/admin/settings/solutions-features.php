	...
	<div class="wcpscwc-sf-wrap">
		<div class="wcpscwc-sf-inr">
			...
			<div class="wcpscwc-sf-features-section wcpscwc-sf-team wcpscwc-sf-center">
				...
				<h1 class="wcpscwc-sf-heading">Only <span class="wcpscwc-sf-blue">November 2022</span> Deal <span class="wcpscwc-sf-blue">40% OFF</span></h1>
				...
				<a href="<?php echo WCPSCWC_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle Deal</a>
			...
			<div class="wcpscwc-sf-features-section wcpscwc-sf-team wcpscwc-sf-center">
					<h1 class="wcpscwc-sf-heading">Powerful Team Behind <span class="wcpscwc-sf-blue">Product Slider and Carousel</span> Including in <span class="wcpscwc-sf-blue">Essential Plugin Bundle</span></h1>
						...
						<a href="<?php echo WCPSCWC_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Bundle Deal</a>
				</div>
